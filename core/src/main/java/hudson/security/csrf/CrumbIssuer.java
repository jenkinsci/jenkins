...
public abstract class CrumbIssuer implements Describable<CrumbIssuer>, ExtensionPoint {
    ...
    public String getCrumb(javax.servlet.ServletRequest request) {
        return getCrumb(request != null ? request.toJakartaServletRequest() : null);
    }
    ...
    protected /* abstract */ String issueCrumb(ServletRequest request, String salt) {
        return Util.ifOverridden(
                () -> issueCrumb(
                        request != null ? javax.servlet.ServletRequest.fromJakartaServletRequest(request) : null, salt),
                CrumbIssuer.class,
                getClass(),
                "issueCrumb",
    ...
    protected String issueCrumb(javax.servlet.ServletRequest request, String salt) {
        return Util.ifOverridden(
                () -> issueCrumb(request != null ? request.toJakartaServletRequest() : null, salt),
                CrumbIssuer.class,
                getClass(),
                "issueCrumb",
    ...
    public boolean validateCrumb(javax.servlet.ServletRequest request, MultipartFormDataParser parser) {
        return validateCrumb(request != null ? request.toJakartaServletRequest() : null, parser);
    }
    ...
    public /* abstract */ boolean validateCrumb(ServletRequest request, String salt, String crumb) {
        return Util.ifOverridden(
                () -> validateCrumb(
                        request != null ? javax.servlet.ServletRequest.fromJakartaServletRequest(request) : null,
                        salt,
                        crumb),
                CrumbIssuer.class,
                getClass(),
    ...
    public boolean validateCrumb(javax.servlet.ServletRequest request, String salt, String crumb) {
        return Util.ifOverridden(
                () -> validateCrumb(request != null ? request.toJakartaServletRequest() : null, salt, crumb),
                CrumbIssuer.class,
                getClass(),
                "validateCrumb",
                ServletRequest.class,
