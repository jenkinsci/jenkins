...
options {
  tokenVocab = LabelExpressionLexer;
}
...
returns [Label l]
locals [Label r]
  : term2 { $l=$term2.ctx.l; } ( IFF term2 { $r=$term2.ctx.l; $l=$l.iff($r); } )*
  ;
...
returns [Label l]
locals [Label r]
  : term3 { $l=$term3.ctx.l; } ( IMPLIES term3 { $r=$term3.ctx.l; $l=$l.implies($r); } )?
  ;

term3
returns [Label l]
locals [Label r]
  : term4 { $l=$term4.ctx.l; } ( OR term4 { $r=$term4.ctx.l; $l=$l.or($r); } )*
  ;

term4
returns [Label l]
locals [Label r]
  : term5 { $l=$term5.ctx.l; } ( AND term5 { $r=$term5.ctx.l; $l=$l.and($r); } )*
  ;
