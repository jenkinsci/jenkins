...
div(name:field) {
    label {
        f.radio(name:type, value:"fixed", checked:port > 0, onclick:"\$('${id}').disabled=false")
        text(_("Fixed"))
        text(" : ")
    }
    ...
    label {
        f.radio(name:type, value:"random", checked:port == 0, onclick:"\$('${id}').disabled=true")
        text(_("Random"))
    }
    ...
    label {
        f.radio(name:type, value:"disable", checked:port == -1, onclick:"\$('${id}').disabled=true")
        text(_("Disable"))
    }
}
