...
var radioBlockSupport = {
  ...
  updateButtons: function () {
    for (var i = 0; i < this.buttons.length; i++) this.buttons[i]();
  },
...
Behaviour.specify(
  ...
  function (r) {
    ...
    var f = r.form;
    var radios = f.radios;
    if (radios == null) f.radios = radios = {};
    ...
    var e = (function () {
      ...
      while (cnt > 0) {
        e = $(e).next();
        if (Element.hasClassName(e, "radio-block-start")) cnt++;
        if (Element.hasClassName(e, "radio-block-end")) cnt--;
      }
      return e;
    })();
