...
public class IconSetTest {
    ...
    @Test
    void getSymbol() {
        String symbol = IconSet.getSymbol("download", "Title", "Tooltip", "class1 class2", IconSet.class);
    ...
    void getSymbol_cachedSymbolDoesntReturnAttributes() {
        IconSet.getSymbol("download", "Title", "Tooltip", "class1 class2", IconSet.class);
        String symbol = IconSet.getSymbol("download", "", "", "", IconSet.class);
    ...
    void getSymbol_cachedSymbolAllowsSettingAllAttributes() {
        IconSet.getSymbol("download", "Title", "Tooltip", "class1 class2", IconSet.class);
        String symbol = IconSet.getSymbol("download", "Title2", "Tooltip2", "class3 class4", IconSet.class);
    ...
    void getSymbol_notSettingTooltipDoesntAddTooltipAttribute() {
        String symbol = IconSet.getSymbol("download", "Title", "", "class1 class2", IconSet.class);
