...
class DoActionFilterTest extends StaplerAbstractTest {
    ...
    public static class TestNewRulesOk extends AbstractUnprotectedRootAction {
        ...
        public void doWithThrowOtherException() { replyOk(); }
    ...
    public static class HttpResponseChild implements HttpResponse {
        @Override
        public void generateResponse(StaplerRequest2 req, StaplerResponse2 rsp, Object node) throws ServletException {
            replyOk();
        }
    }
    ...
    public static class ExceptionImplementingOnlyHttpResponse extends RuntimeException implements HttpResponse {
        @Override
        public void generateResponse(StaplerRequest2 staplerRequest, StaplerResponse2 staplerResponse, Object o) throws ServletException {
            replyOk();
        }
    }
