...
Jenkins core is a central component of the project which serves millions of users worldwide, and it is critical to maintain it in a good shape.
...
* There are multiple atomic commits. Each commit has a reasonable message and can be built independently.
