...
in light of the commitment to closing pull requests that such membership implies.
...
Failure to negotiate reasonably can often chase contributors away.
...
and would not be reasonable to the assignee if a large amount of additional work is necessary.
