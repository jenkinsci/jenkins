...
* link:https://github.com/jenkins-infra/helpdesk/issues?q=is%3Aissue%20is%3Aopen%20label%3Atriage[Jenkins core triage board] -
  Lists untriaged issues in the Jenkins core and bundled components.
* link:https://github.com/jenkins-infra/helpdesk/issues?q=is%3Aissue%20is%3Aopen%20type%3ABug%20sort%3Aupdated-desc[Core maintainers board] -
...
* If it would make sense to backport the change to LTS, then either the a pull request or issue needs to be labeled as `lts-candidate` to be considered.
