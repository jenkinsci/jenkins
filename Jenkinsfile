            ...
            timeout(time: 12, unit: 'HOURS') {
              for (int i = 1; i <= 400; i++) {
                ...
                def mavenOptions = [
                  ...
                  '-Dtest=hudson.bugs.JnlpAccessWithSecuredHudsonTest,hudson.slaves.JNLPLauncherRealTest,hudson.slaves.NodeParallelTest,jenkins.agents.WebSocketAgentsTest,jenkins.security.Security218Test,jenkins.slaves.restarter.JnlpSlaveRestarterInstallerTest',
                  '-DforkCount=2',
