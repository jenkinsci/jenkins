...
describe("tabbar-spec tests", function () {
  ...
  it("- test row-group modeling", function (done) {
    jsTest.onPage(function () {
      ...
      expect(generalSection.getRowGroupLabels().toString()).toBe(
        "Discard Old Builds"
      );
  ...
  it("- test finder - via handler triggering", function (done) {
    jsTest.onPage(function () {
      ...
      setTimeout(function () {
        ...
        expect(textCleanup($(".tab.hidden", tabBar).text())).toBe(
          "Advanced Project OptionsBuild TriggersBuild"
        );
  ...
  it("- test adopt sections ", function (done) {
    jsTest.onPage(function () {
      ...
      expect(textCleanup($(".tab", tabBar).text())).toBe(
        "GeneralAdvanced Project OptionsBuild TriggersBuild"
      );
  ...
  it("- test getSibling ", function (done) {
    jsTest.onPage(function () {
      ...
      var config__advanced_project_options = configTabBar.getSection(
        "config_advanced_project_options"
      );
      var config__build_triggers = configTabBar.getSection(
      ...
      expect(config_general.getSibling(+1)).toBe(
      ...
      expect(config__advanced_project_options.getSibling(-1)).toBe(
        config_general
      );
      expect(config__advanced_project_options.getSibling(0)).toBe(
        config__advanced_project_options
      );
      expect(config__advanced_project_options.getSibling(+1)).toBe(
        config__build_triggers
      );
      expect(config__advanced_project_options.getSibling(+2)).toBe(
        config__build
      );
