    ...
    page.onload(
      ...
      function () {
        ...
        if (configTables.length > 0) {
          var tabBarShowPreference = jenkinsLocalStorage.getGlobalItem(
          ...
          if (tabBarShowPreference === "yes") {
            configTables.each(function () {
              ...
              tabBar.deactivator.click(function () {
                jenkinsLocalStorage.setGlobalItem(
                  tabBarShowPreferenceKey,
                  "no"
                );
...
export var addTabs = function (configTable, options) {
  ...
  var noTabs = $(
    '<div class="noTabs" title="Remove configuration tabs and revert to the &quot;classic&quot; configuration view">Remove tabs</div>'
  );
...
export var addFinderToggle = function (configTableMetadata) {
  ...
  if (
    jenkinsLocalStorage.getGlobalItem(finderShowPreferenceKey, "yes") === "yes"
  ) {
    findToggle.click();
  }
};
