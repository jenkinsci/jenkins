...
public class MavenModuleTest {
    ...
    public void testMultipleDependencies() {
        ...
        assertEquals(0, downstreamA.size());
        assertEquals(1, upstreamA.size());
        assertSame(dependY.getVersion(), ((MavenModule) upstreamA.get(0)).getVersion());
        ...
        assertEquals(0, downstreamB.size());
        assertEquals(1, upstreamA.size());
        assertSame(dependZ.getVersion(), ((MavenModule) upstreamB.get(0)).getVersion());
    }
